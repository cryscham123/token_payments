# Step 3: rbac-seed-audit-public-verification
...
3. docs를 갱신한다.
   ...
   - group/role/permission 관리 API는 admin seed/provisioning 범위와 future API 범위를 구분한다.
   - 필요한 경우 기존 admin membership provisioning route는 merchant group membership 생성/수정으로 연결하되, role/permission CRUD route를 함께 추가하지 않는다.
