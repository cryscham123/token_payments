# Step 2: product-catalog-detail-model
...
상품을 checkout/payment projection이 아니라 canonical product catalog로 보강한다. Elasticsearch는 아직 붙이지 않고, 이후 projection/search phase가 읽을 수 있는 structured metadata만 둔다.
