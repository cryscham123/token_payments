    ...
    def initialize_order(
        ...
        if item_requests:
            ...
            for product_id, quantity in (product_quantities or {}).items():
                product = store.require_product(product_id)
                items.append(
                    OrderItem.from_product(order_id, product, quantity, snapshotted_at, conversion=conversion)
                )
